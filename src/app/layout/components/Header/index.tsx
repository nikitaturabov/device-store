    ...
    <div className='border py-3 px-6'>
      ...
      <div className='mt-4 flex items-center justify-between'>
        ...
        <div className='flex gap-x-8'>
          ...
          <span
            className='cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-gray-100'>New Releases</span>
          ...
          <span
            className='cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-gray-100'>Toys & Games</span>
        </div>

        <span
          className='cursor-pointer rounded-sm py-1 px-2 text-sm font-medium hover:bg-gray-100'>Becoma a seller</span>
      </div>
    </div>
  </header>;
};
